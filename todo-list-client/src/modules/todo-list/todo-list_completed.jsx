...
import { getEntities, updateEntity, getEntitiesCompleted } from './todo-list.reducer';

class TodoListCompleted extends React.Component {

    componentDidMount() {
        this.props.getEntitiesCompleted();
    }
...
const mapDispatchToProps = { getEntities, updateEntity, getEntitiesCompleted };
